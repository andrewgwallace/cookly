...
# Make a cookbook title by splitting the the name and putting it into a phrase
...
# Different ways to present Cookbook Title Information
  name_patterns = [
...
100.times do
  ...
  10.times do
    # add each of theose 10 recipes to the array of recipes
    recipe = Recipe.new
    ...
    3.times do
      ...
      # Using a custom Model Method called .add_portion (make in recipe.rb file)
      recipe.add_portion(
        random_quantity,
        unit_names.sample,
  ...
  # Add each recipe from the array to the cookbook
